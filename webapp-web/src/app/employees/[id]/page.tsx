...
import {
  ...
  Briefcase, Clock, MapPin, Calendar, AlertTriangle,
  ChevronRight, Edit3, ToggleRight, ToggleLeft,
  Trash2, Send, Copy, UserCheck, Activity,
} from 'lucide-react';
  ...
  return (
    <div className="flex h-screen bg-slate-950">
      ...
      <main className="flex-1 overflow-y-auto">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  <h1 className="text-white font-bold text-xl">{member.full_name}</h1>
        ...
        {/* Stats strip */}
        <div className="grid grid-cols-4 gap-0 border-b border-slate-700">
          {[
            ...
            <div key={s.label} className={`bg-slate-900/60 px-6 py-4 flex items-center gap-3 ${i < 3 ? 'border-r border-slate-700' : ''}`}>
