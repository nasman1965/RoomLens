...
const ROLES = [
  {
    ...
    description: 'Full access: jobs, team, billing, settings & all controls.',
    redirect: '/dashboard',
  },
  {
    id: 'management_admin',
    label: 'Management Admin',
    sublabel: 'Supervisors & managers',
    icon: <Users className="w-6 h-6" />,
    color: 'border-purple-500 bg-purple-600',
    bg: 'bg-purple-900/20 border-purple-700/40 hover:border-purple-500',
    badge: 'Level 2 — Manager',
    badgeColor: 'bg-purple-900/60 text-purple-300',
    description: 'Operational access: jobs, dispatch, reports. No billing or staff management.',
    redirect: '/dashboard',
  },
  {
    id: 'staff',
